-- Fix 1: Update get_user_active_subscription to include 'trial' status
...
-- Fix 2: Update check_package_limits to fix ambiguous column reference
...
BEGIN
  ...
  SELECT sub.package_name INTO v_package_name
...
-- Fix 3: Update get_user_effective_limits to be VOLATILE (allows INSERT operations)

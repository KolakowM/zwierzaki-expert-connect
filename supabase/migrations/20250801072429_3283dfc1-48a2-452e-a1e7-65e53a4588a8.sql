...
-- Update the get_catalog_specialists function to return NULL instead of hardcoded Unsplash image
...
BEGIN
    ...
    specialist_data AS (
        SELECT 
            ...
            sp.photo_url as specialist_image,  -- Return actual photo_url or NULL
    ...
    SELECT 
        ...
        pr.specialist_image,  -- This will now be NULL when no photo_url exists
        pr.specialist_email,
        5 as rating,
        true as verified,

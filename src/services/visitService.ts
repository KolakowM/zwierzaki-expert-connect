...
export const createVisit = async (visit: Omit<Visit, 'id'>): Promise<Visit> => {
  ...
  const prepared = {
    ...visit,
    date: typeof visit.date === 'object' && visit.date !== null ? visit.date.toISOString() : visit.date,
    followUpDate: typeof visit.followUpDate === 'object' && visit.followUpDate !== null ? visit.followUpDate.toISOString() : visit.followUpDate
  };

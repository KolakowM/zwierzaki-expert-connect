        ...
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <div className="space-y-8 pt-4">
            ...
            <div className="space-y-3">
              ...
              <p>
                4. Dane przechowywane są przez okres:
              </p>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <p>
                5. Użytkownik ma prawo do dostępu, sprostowania, usunięcia, ograniczenia przetwarzania, 
                przenoszenia danych oraz wniesienia sprzeciwu.
              </p>
              <p>
                6. Dane mogą być przekazywane do krajów trzecich wyłącznie z odpowiednimi zabezpieczeniami.
              </p>
            </div>

  ...
  async function onSubmit(values: ContactFormValues) {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || "Wystąpił błąd podczas wysyłania wiadomości. Spróbuj ponownie.",
        variant: "destructive"
      });
    } finally {
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            <Card className="p-6">
              <div className="flex flex-col items-center space-y-3 text-center">
                ...
                <p className="text-muted-foreground">Zadzwoń do nas</p>
                <p>+48 123 456 789</p>
            ...
            <Card className="p-6">
              <div className="flex flex-col items-center space-y-3 text-center">
                ...
                <h3 className="text-xl font-medium">Lokalizacja</h3>
                <p className="text-muted-foreground">Nasze biuro</p>
                <p>Warszawa, Polska</p>

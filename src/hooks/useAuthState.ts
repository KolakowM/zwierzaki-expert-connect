...
Now I need to update the useAuthListeners hook to accept the correct parameters:

<lov-write file_path="src/hooks/useAuthListeners.ts">
...
export function useAuthListeners({
  ...
  }, [setUser, setSessionChecked, setIsLoading]);
}
